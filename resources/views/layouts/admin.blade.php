    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="{{ route('dashboard') }}">{{ Str::words(Auth::user()->name, 1, '...') }}</a>
                                ...
                                <li class="connection-list">
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                            <a href="{{ route('product.index') }}" class="connection-item"><img src="{{ asset('assets') }}/images/github.png" alt="" > <span>Produk</span></a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                            <a href="{{ route('customer.index') }}" class="connection-item"><img src="{{ asset('assets') }}/images/dribbble.png" alt="" > <span>Customer</span></a>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                            <a href="{{ route('order.index') }}" class="connection-item"><img src="{{ asset('assets') }}/images/dropbox.png" alt="" > <span>Order</span></a>
                                        </div>
                                    </div>
                                </li>
                                <li>
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <form action="{{ route('logout') }}" method="post">
                                    @csrf
                                    <button type="submit" class="dropdown-item" onclick="return confirm('are you sure?')"><i class="fas fa-power-off mr-2"></i>Logout</button>
                                </form>
                            </div>
                        </li>
                    </ul>
